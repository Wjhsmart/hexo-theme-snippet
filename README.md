...
如果本主题也是你喜欢的菜，请动动手指 [Star](https://github.com/Wjhsmart/hexo-theme-snippet/stargazers) 支持一下

[![Build Status](https://www.travis-ci.org/Wjhsmart/hexo-theme-snippet.svg?branch=master)](https://www.travis-ci.org/Wjhsmart/hexo-theme-snippet)
[![Read the Docs](https://img.shields.io/readthedocs/pip/stable.svg)](https://github.com/Wjhsmart/hexo-theme-snippet/blob/master/README.md)
[![HitCount](http://hits.dwyl.io/Wjhsmart/hexo-theme-snippet.svg)](http://hits.dwyl.io/Wjhsmart/hexo-theme-snippet)
[![mnt-image](https://img.shields.io/maintenance/yes/2018.svg)](../../commits/master)
[![codebeat badge](https://codebeat.co/badges/6ef2dcd2-af90-40e0-9628-ac689441f774)](https://codebeat.co/projects/github-com-Wjhsmart-hexo-theme-snippet-master)
[![GitHub stars](https://img.shields.io/github/stars/Wjhsmart/hexo-theme-snippet.svg)](https://github.com/Wjhsmart/hexo-theme-snippet/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/Wjhsmart/hexo-theme-snippet.svg)](https://github.com/Wjhsmart/hexo-theme-snippet/network)
[![hexo version](https://img.shields.io/badge/hexo-%3E%3D%203.0-blue.svg)](http://hexo.io)
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/Wjhsmart/hexo-theme-snippet/blob/master/LICENSE)


[主题Demo戳这里](http://Wjhsmart.github.io?rf=gh-demo)

![hexo-theme-snippet](http://snippet.Wjhsmart.com/img/snippet-screenshots1000.jpg "Snippet主题")
...
1. 下载 [Snippet主题](https://github.com/Wjhsmart/hexo-theme-snippet) 文件解压后放在 `themes` 目录下，和博客中的landscape为同级目录

2. Git方式，在Hexo根目录执行：
``` bash
git clone git://github.com/Wjhsmart/hexo-theme-snippet.git themes/hexo-theme-snippet
```
...
notification: |-
            <p>主题已经上线！欢迎下载或更新~ <br/>
            主题下载：<a href="https://github.com/Wjhsmart/hexo-theme-snippet" title="fork me" target="_blank">Snippet主题</a> <br/>
            <hr/>接受贡献，包括不限于提交问题与需求，修复代码。欢迎Pull Request<br/>支持主题：<a href="https://github.com/Wjhsmart/hexo-theme-snippet/stargazers">Star一下</a></p>

## 社交设置{@name:社交工具名字，@icon:社交工具图标，@href:设置工具链接} [参考图标](http://fontawesome.io/icons/)
social:
  - name: Github
    icon: git
    href: //github.com/Wjhsmart
...
## 例如：http://snippet.Wjhsmart.com/img/banner|2|3.jpg, 或者 './img/banner-img.jpg'(相对本地资源地址)
banner:
  img: http://snippet.Wjhsmart.com/img/banner.jpg
...
env:
  global:
   - GH_REF: github.com/Wjhsmart/Wjhsmart.github.io.git #更改为自己git地址
```
...
如果觉得本主题还不错，== 欢迎  [Star](https://github.com/Wjhsmart/hexo-theme-snippet/stargazers)下 ==，您的支持和鼓励才是后续更新最大的动力
...
> 没有找到我需要的问题： [提Issues](https://github.com/Wjhsmart/hexo-theme-snippet/issues/new)
